        ...
        if(pair) {
            if(pair.master.id === obj.id) {
                ...
                let loc = {
                    ...
                    pov: obj.get('limit_field_of_vision_center')
                };
                ...
                let pov=pair.master.get('limit_field_of_vision_center');
                let npov=pair.master.get('limit_field_of_night_vision_center');
                ...
                pair.master.set({
                    ...
                    top: loc.top,
                    left: loc.left,
                    limit_field_of_vision_center: loc.pov,
                    limit_field_of_night_vision_center: loc.npov
                });
